...
$day = 24*60*60;
$lk_prev30 = base_url('index.php/financeiro/cpagar/'.date("Ymd",$data-$day*30));
$lk_prev7 = base_url('index.php/financeiro/cpagar/'.date("Ymd",$data-$day*7));
$lk_prev1 = base_url('index.php/financeiro/cpagar/'.date("Ymd",$data-$day));
$lk_today = base_url('index.php/financeiro/cpagar/'.date("Ymd"));
$lk_next1 = base_url('index.php/financeiro/cpagar/'.date("Ymd",$data+$day));
$lk_next7 = base_url('index.php/financeiro/cpagar/'.date("Ymd",$data+$day*7));
$lk_next30 = base_url('index.php/financeiro/cpagar/'.date("Ymd",$data+$day*30));
$lk_new = '#" onclick="newxy(\''.base_url('index.php/financeiro/cpagar_edit/0/0').'\',800,800);';
$lk_new_multi = '#" onclick="newxy(\''.base_url('index.php/financeiro/cpagar_edit_multi/0/0').'\',800,800);';
$lk_refresh = base_url('index.php/financeiro/cpagar/'.$date);
$lk_search = base_url('index.php/financeiro/cpagar_search');
